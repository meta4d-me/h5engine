    ...
    (function (framework) {
        ...
        var assetMgr = (function () {
            ...
            assetMgr.prototype.loadSingleRes = function (url, type, onstate, state) {
                ...
                if (type == AssetTypeEnum.GLVertexShader) {
                    ...
                    gd3d.io.loadText(url, function (txt, err) {
                        ...
                        img.onload = function () {
                            var _texture = new framework.texture(filename);
                            _this.assetUrlDic[_texture.getGUID()] = _textureSrc;
                            var t2d = new gd3d.render.glTexture2D(_this.webgl, _textureFormat);
            ...
            assetMgr.prototype.saveScene = function (fun) {
                ...
                var _scene = {};
                var _rootNode = gd3d.io.serializeObj(this.app.getScene().getRoot());
                var _lightmaps = [];
            ...
            assetMgr.prototype.savePrefab = function (trans, prefabName, fun) {
                ...
                _prefab.apply(trans);
                var _rootTrans = gd3d.io.serializeObj(trans);
        ...
        var effectSystem = effectSystem_1 = (function () {
                ...
                if (this.state == framework.EffectPlayStateEnum.Play) {
                    ...
                    for (var i in this.effectBatchers) {
                        ...
                        mesh_1.submesh = [];
                        {
                            ...
                            sm.line = false;
                            mesh_1.submesh.push(sm);
                        }
                        subEffectBatcher.mat.draw(context, mesh_1, sm, "base");
                    }
                    if (this.particles != undefined) {
            ...
            effectSystem.prototype.addInitFrame = function (elementData) {
                ...
                for (var i_3 = 0; i_3 < vertexCount; i_3++) {
                    ...
                    {
                        var r = gd3d.math.floatClamp(vertexArr[i_3 * vertexSize + 9], 0, 1);
                        var g = gd3d.math.floatClamp(vertexArr[i_3 * vertexSize + 10], 0, 1);
                        var b = gd3d.math.floatClamp(vertexArr[i_3 * vertexSize + 11], 0, 1);
                        var a = gd3d.math.floatClamp(vertexArr[i_3 * vertexSize + 12], 0, 1);
                    ...
                    {
                        subEffectBatcher.dataForVbo[(vertexStartIndex + i_3) * vertexSize + 13] = vertexArr[i_3 * vertexSize + 13];
                        subEffectBatcher.dataForVbo[(vertexStartIndex + i_3) * vertexSize + 14] = vertexArr[i_3 * vertexSize + 14];
                    }
                }
                ...
                if (elementData.type == framework.EffectElementTypeEnum.SingleMeshType) {
                }
                else if (elementData.type == framework.EffectElementTypeEnum.EmissionType) {
                }
    ...
    (function (framework) {
        var trailRender = (function () {
            function trailRender() {
                ...
                this.endColor = new gd3d.math.color(1, 1, 1, 1);
                this.nodes = [];
            }
            trailRender.prototype.start = function () {
                ...
                this.meshf = this.trailTrans.gameObject.addComponent(framework.StringUtil.COMPONENT_MESHFILTER);
                this.meshrender = this.trailTrans.gameObject.addComponent(framework.StringUtil.COMPONENT_MESHRENDER);
            ...
            trailRender.prototype.recordTrailNode = function (time) {
                var pos = new gd3d.math.vector3();
                gd3d.math.vec3Clone(this.gameObject.transform.getWorldTranslate(), pos);
                var length = this.nodes.length;
                if (length != 0) {
                    if (gd3d.math.vec3Distance(pos, this.nodes[0].location) < 0.02)
                        return;
                }
            ...
            trailRender.prototype.updateTrail = function (curTime) {
                ...
                for (var i = 0; i < this.nodes.length; i++) {
                    ...
                    var _width = this.startWidth + (this.endWidth - this.startWidth) * u;
                ...
                var meshdata = new gd3d.render.meshData();
        ...
        function cloneOtherType(instanceObj, clonedObj, key, instanceParent, clonedParent, instanceKey) {
            ...
            if (_meta["class"] && _meta["class"]["custom"] && (_meta["class"]["custom"]["SerializeType"] || _meta["class"]["custom"]["nodecomp"] || _meta["class"]["custom"]["2dcomp"])) {
                ...
                if (io.isAsset(type)) {
                    ...
                    if ((isArray_2 && instanceParent["__gdmeta__"] && instanceParent["__gdmeta__"]["class"] && instanceParent["__gdmeta__"]["class"]["custom"] && (instanceParent["__gdmeta__"]["class"]["custom"]["nodecomp"] || instanceParent["__gdmeta__"]["class"]["custom"]["2dcomp"])) ||
                        (!isArray_2 && instanceObj["__gdmeta__"] && instanceObj["__gdmeta__"]["class"] && instanceObj["__gdmeta__"]["class"]["custom"] && (instanceObj["__gdmeta__"]["class"]["custom"]["nodecomp"] || instanceObj["__gdmeta__"]["class"]["custom"]["2dcomp"]))) {
...
(function (gd3d) {
    ...
    (function (io) {
        ...
        function serializeOtherTypeOrArrayForInspector(instanceObj, serializedObj, key, beComponent) {
            if (instanceObj[key]) {
                if (instanceObj[key]["__gdmeta__"]) {
                    ...
                    var isArray_3 = instanceObj[key] instanceof Array;
                    if (isArray_3)
                ...
                var isArray_4 = instanceObj instanceof Array;
        ...
        function serializeOtherTypeOrArray(instanceObj, serializedObj, key) {
            if (instanceObj[key]) {
                if (instanceObj[key]["__gdmeta__"]) {
                    ...
                    var isArray_6 = instanceObj[key] instanceof Array;
                    if (isArray_6)
        ...
        function serializeOtherType(instanceObj, serializedObj, key, arrayInst) {
            ...
            var _meta = instanceObj[key]["__gdmeta__"];
            if (_meta["class"] && _meta["class"]["custom"] && (_meta["class"]["custom"]["SerializeType"] || _meta["class"]["custom"]["nodecomp"] || _meta["class"]["custom"]["2dcomp"])) {
                var isArray_7 = instanceObj instanceof Array;
                var type = _meta["class"]["typename"];
                if (isAsset(type)) {
                    var _defaultAsset = instanceObj[key].defaultAsset;
                    var _assetName = instanceObj[key].getName();
                    ...
                    var isreference = false;
                    var insid = -1;
                    if ((isArray_7 && arrayInst["__gdmeta__"] && arrayInst["__gdmeta__"]["class"] && arrayInst["__gdmeta__"]["class"]["custom"] && (arrayInst["__gdmeta__"]["class"]["custom"]["nodecomp"] || arrayInst["__gdmeta__"]["class"]["custom"]["2dcomp"])) ||
                        (!isArray_7 && instanceObj["__gdmeta__"] && instanceObj["__gdmeta__"]["class"] && instanceObj["__gdmeta__"]["class"]["custom"] && (instanceObj["__gdmeta__"]["class"]["custom"]["nodecomp"] || instanceObj["__gdmeta__"]["class"]["custom"]["2dcomp"]))) {
                        if (_meta["class"]["custom"]["nodecomp"]) {
                            insid = instanceObj[key]["gameObject"]["transform"]["insId"].getInsID();
                            isreference = true;
                        }
            ...
            EffectElement.prototype.updateElementRotation = function () {
                ...
                if (this.curAttrData.renderModel != framework.RenderModel.None) {
                    ...
                    if (this.curAttrData.renderModel == framework.RenderModel.BillBoard) {
                        ...
                        var rightTarget = gd3d.math.pool.new_vector3();
    ...
    (function (framework) {
        ...
        var EmissionBatcher = (function () {
            ...
            EmissionBatcher.prototype.render = function (context, assetmgr, camera) {
                {
                    var mesh_2 = this.mesh;
                    if (!this.beBufferInited) {
                        mesh_2.glMesh.initBuffer(context.webgl, this.formate, this.curTotalVertexCount);
                        this.beBufferInited = true;
                    }
                    mesh_2.glMesh.uploadVertexSubData(context.webgl, this.dataForVbo);
                    mesh_2.glMesh.addIndex(context.webgl, this.dataForEbo.length);
                    mesh_2.glMesh.uploadIndexSubData(context.webgl, 0, this.dataForEbo);
                    mesh_2.submesh = [];
                    {
                        var sm = new framework.subMeshInfo();
                        sm.matIndex = 0;
                        ...
                        sm.size = this.dataForEbo.length;
                        sm.line = false;
                        mesh_2.submesh.push(sm);
                    }
                    this.mat.draw(context, mesh_2, sm, "base");
                }
            };
            ...
            ParticleNew1.prototype.initByData = function () {
                ...
                if (this.renderModel == framework.RenderModel.None || this.renderModel == framework.RenderModel.StretchedBillBoard) {
                    ...
                    if (this.data.particleStartData.shapeType != framework.ParticleSystemShape.NORMAL) {
                        var localOrgin = gd3d.math.pool.new_vector3();
