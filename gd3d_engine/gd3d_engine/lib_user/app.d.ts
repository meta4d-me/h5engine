...
declare class effecteditor implements gd3d.framework.IUserCode {
    ...
    basePath: string;
    resPath: string;
    constructor(_basePath?: string, _resPath?: string);
    private particleUrl;
    private currentOpValue;
    private fileList;
    private role;
    private effectListBoxs;
    private functionArea;
    private currentEffectNameList;
    private currentEffectName;
    private effectParentTransform;
    private curEffectTrans;
    frameWidth: number;
    frameHeight: number;
    scale: number;
    ...
    private effect;
    private currentDiv;
    private addEffectToPlayList(effectName);
    private isTrail;
    private _loadEffect(fullName, name);
    private setFunctionArea();
    private addcam(laststate, state);
    private loadUIBoard(laststate, state);
...
declare namespace effectshow {
    class test_effectmain implements IState {
        app: gd3d.framework.application;
        scene: gd3d.framework.scene;
        feature: Ifeature;
        basePath: string;
    ...
    function addbtn(top: string, left: string, text: string): HTMLButtonElement;
}
declare namespace t {
...
declare namespace t {
    class test_LevelUpWithRoleMove implements IState {
        app: gd3d.framework.application;
        scene: gd3d.framework.scene;
        camera: gd3d.framework.camera;
        taskmgr: gd3d.framework.taskMgr;
...
declare class test_effect implements IState {
    ...
    private loadEffect(laststate, state);
    private currentDiv;
    private addEffectToPlayList(filename);
    private currentOpValue;
    private setFunctionArea();
    private addcam(laststate, state);
    private addcube(laststate, state);
    ...
    start(app: gd3d.framework.application): void;
    private particleUrl;
    _loadEffect(fullName: string, name: string): void;
    private tileX;
    private tileY;
    private row;
    private column;
    private uvSpirteTime;
    private framerate;
    private interframeSpace;
    private UVPlay;
    update(delta: number): void;
}
declare class effectshowMgr {
    app: gd3d.framework.application;
    scene: gd3d.framework.scene;
    camera: gd3d.framework.camera;
    taskmgr: gd3d.framework.taskMgr;
    ...
    private effect;
    private currentDiv;
    loadeffect(fullName: string, name: string): void;
    private addcam(laststate, state);
    sceneFrame: gd3d.framework.transform;
    onStart(app: gd3d.framework.application): void;
    private addcube(laststate, state);
...
declare class test_effect_1 implements IState {
    app: gd3d.framework.application;
    scene: gd3d.framework.scene;
    camera: gd3d.framework.camera;
    timer: number;
...
declare class test_integratedsystem implements IState {
    app: gd3d.framework.application;
    scene: gd3d.framework.scene;
    camera: gd3d.framework.camera;
    private UIBoard;
