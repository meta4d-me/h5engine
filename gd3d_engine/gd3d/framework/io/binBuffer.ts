namespace gd3d.io
{
    ...
    // {
    //     private static instance: readBuffer;
    //     public static get Instance()
    //     {
    //         if (!readBuffer.instance)
    //             readBuffer.instance = new readBuffer();
    //         return readBuffer.instance;
    //     }
    //     private bytes = new Uint8Array(655350);
    //     private offset = 0;
    //     private set Offset(offset: number)
    //     {
    //         this.offset += 4;
    //         if(this.offset >= 655342)
    //             this.offset = 0;
    //     }
    ...
    //     constructor()
    //     {
    //         this.view = new DataView(this.bytes.buffer, this.bytes.byteLength);
    //     }

    //     readSingle(): number
    //     {
    //         let ret = this.view.getFloat32(this.offset, true);
    //         this.Offset += 4;
    //         return ret;
    //     }
    // }
