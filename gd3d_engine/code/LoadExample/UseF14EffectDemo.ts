//加载并使用特效
class UseF14EffectDome implements IState {
    ...
    private useF14Effect() {
        ...
        this.effectSystems = this.eff.gameObject.getComponentsInChildren("f14EffectSystem") as gd3d.framework.f14EffectSystem[];
        this.eff.markDirty();
    ...
    addCtrl() {
        ...
        play.onclick = (e) => {
            for (let i in this.effectSystems) {
                //播放特效
                this.effectSystems[i].play(1.0);
            }
