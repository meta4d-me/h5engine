...
var test_3DPhysics_cannon = (function () {
    ...
    test_3DPhysics_cannon.prototype.init = function () {
        ...
        this.scene.enablePhysics(new gd3d.math.vector3(0, -9.8, 0), new gd3d.framework.OimoJSPlugin());
        var ctrBoxImpostor = new gd3d.framework.PhysicsImpostor(ctrBox, gd3d.framework.ImpostorType.BoxImpostor, { mass: 1, restitution: 0.8 });
        ...
        var s_top_Impostor = new gd3d.framework.PhysicsImpostor(sphere_top, gd3d.framework.ImpostorType.SphereImpostor, { mass: 1, restitution: 0.3 });
    ...
    test_3DPhysics_cannon.prototype.onPonitMove = function (_a) {
        var x = _a[0], y = _a[1];
        var viewPos = help_v2;
        viewPos.x = x;
        viewPos.y = y;
        ...
        if (!this.cachePickInfo || !this.cachePickInfo.hitposition)
            return;
    ...
    test_3DPhysics_cannon.prototype.updateRoate = function () {
        if (!this.ctrBox)
            return;
        this.cache_y += 3;
