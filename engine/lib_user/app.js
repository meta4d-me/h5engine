...
var demo_navigaionRVO = (function () {
    function demo_navigaionRVO() {
        this.cubesize = 0.5;
        this.rvoMgr = new m4m.framework.RVOManager();
    ...
    demo_navigaionRVO.prototype.loadScene = function (assetName, isCompress) {
        ...
        if (isCompress) {
            ...
            this.app.getAssetMgr().load("res/scenes/" + assetName + "/" + assetName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s1) {
                if (s1.isfinish) {
                    addScene();
                }
            });
...
var dome_loadaniplayer = (function () {
    ...
    dome_loadaniplayer.prototype.loadRole = function (laststate, state) {
        ...
        this.app.getAssetMgr().load("res/prefabs/roles/" + name + "/" + name + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
            if (s.isfinish) {
    ...
    dome_loadaniplayer.prototype.loadSkill = function (name) {
        this.assetmgr.load("res/prefabs/roles/" + this.roleName + "/Resources/" + name, m4m.framework.AssetTypeEnum.Auto, function (s) {
        });
    };
    dome_loadaniplayer.prototype.loadWeapon = function (name) {
        var _this = this;
        this.assetmgr.load("res/prefabs/weapons/" + name + "/" + name + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
            if (s.isfinish) {
                var p = _this.assetmgr.getAssetByName(name + ".prefab.json");
...
var test_01 = (function () {
    ...
    test_01.prototype.testNRes = function (root) {
        ...
        var assetMgr = this.app.getAssetMgr();
        assetMgr.load(cndroot + "shader/customShader/customShader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (state) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (state.isfinish) {
                    assetMgr.mapShader = this.app.getAssetMgr().mapShader;
                    assetMgr.load(cndroot + "props/PC/role/PF_PlayerSharkReef/PF_PlayerSharkReef.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (state) {
                        if (state.isfinish) {
                            console.log("资源加载结束");
...
var test_loadScene = (function () {
    ...
    test_loadScene.prototype.start = function (app) {
        ...
        util.loadShader(assetMgr)
            ...
            assetMgr.load("newRes/pfb/scene/" + sceneName + "/" + sceneName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s1) {
                if (s1.isfinish) {
...
var testReload = (function () {
    ...
    testReload.prototype.createChangeBtn = function (role, role1, o2d, part) {
        ...
        btn.transition = m4m.framework.TransitionType.ColorTint;
        o2d.addChild(t2d_9);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        m4m.framework.transform.prototype["checkToTop"] = function () { };
                        return [2];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.isEnableGUI) return [3, 2];
                        return [4, this.enableGUI()];
                    case 1:
                        _a.sent();
                        return [3, 3];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        return [4, demoTool.loadbySync("newRes/test/shader/customShader/customShader.assetbundle.json", this.app.getAssetMgr())];
                    case 2:
                        _b.sent();
                        exp = (_a = ambientCubemapLight.exposure) !== null && _a !== void 0 ? _a : 4;
                        return [4, this.loadCubeTexture("" + this.HDRpath + this._HDR + "/")];
                    case 3:
                        env = _b.sent();
                        return [4, this.loadCubeTexture("" + this.HDRpath + this._HDR + "_diff/")];
                    case 4:
...
var test_UI_Component = (function () {
    ...
    test_UI_Component.prototype.createUI = function (astState, state) {
        ...
        ipt.LineType = m4m.framework.lineType.SingleLine;
        ...
        ipt_mul.LineType = m4m.framework.lineType.MultiLine_NewLine;
        ...
        this.assetMgr.load("res/comp/comp.json.png", m4m.framework.AssetTypeEnum.Auto, function (s) {
            if (s.isfinish) {
                _this.assetMgr.load("res/comp/comp.atlas.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                    if (s.isfinish) {
                        _this.assetMgr.load("res/fonts/" + fontpng, m4m.framework.AssetTypeEnum.Auto, function (s) {
                            if (s.isfinish) {
                                _this.assetMgr.load("res/fonts/" + fontjson, m4m.framework.AssetTypeEnum.Auto, function (s) {
                                    _this.assetMgr.load("res/zg03_256.png", m4m.framework.AssetTypeEnum.Auto, function (s) {
                                        if (s.isfinish) {
                                            state.finish = true;
                                        }
                                    });
...
(function (t_1) {
    var test_blend = (function () {
        ...
        test_blend.prototype.loadShader = function (laststate, state) {
            this.app.getAssetMgr().load("newRes/shader/Mainshader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (_state) {
                if (_state.isfinish) {
                    state.finish = true;
                }
            });
        ...
        test_blend.prototype.loadText = function (laststate, state) {
            ...
            this.app.getAssetMgr().load("res/trailtest2.png", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
                    t--;
                    if (t == 0) {
                        state.finish = true;
        ...
        test_rendertexture.prototype.add3dmodelbeforeUi = function (laststate, state) {
            {
                ...
                modelcam.lookatPoint(new m4m.math.vector3(0, 0, 0));
                modelcam.markDirty();
            }
            {
                var cube = new m4m.framework.transform();
...
(function (demo) {
    var DragonTest = (function () {
        ...
        DragonTest.prototype.loadLongPrefab = function (laststate, state) {
            var _this = this;
            var resName = "long";
            this.app.getAssetMgr().load("res/prefabs/" + resName + "/" + resName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
        ...
        DragonTest.prototype.loadScene = function (laststate, state) {
            var _this = this;
            this.app.getAssetMgr().load("res/scenes/test_scene/test_scene.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
...
var test_pick_boxcollider = (function () {
    ...
    test_pick_boxcollider.prototype.loadScene = function (assetName, isCompress) {
        ...
        this.app.getAssetMgr().load("newRes/pfb/scene/" + assetName + "/" + assetName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s1) {
            if (s1.isfinish) {
                addScene();
            }
        });
...
var test_spine_additiveBlending = (function () {
    ...
    test_spine_additiveBlending.prototype.start = function (app) {
        ...
        var assetManager = new spine_m4m.SpineAssetMgr(app.getAssetMgr(), "./res/spine/");
...
var test_sssss = (function () {
    ...
    test_sssss.prototype.init = function () {
        ...
        this.app.getAssetMgr().load("newRes/shader/MainShader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (state) {
            if (state.isfinish) {
                name = "Head";
                _this.app.getAssetMgr().load("newRes/prefabs/" + name + "/" + name + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                    if (s.isfinish) {
                        var _prefab = _this.app.getAssetMgr().getAssetByName(name + ".prefab.json");
                        _this.baihu = _prefab.getCloneTrans();
                        _this.scene.addChild(_this.baihu);
    ...
    test_sssss.prototype.loadpbrRes = function (lastState, state) {
        var _this = this;
        this.app.getAssetMgr().load("res/pbrRes/SSSSS/" + "albedo.jpg", m4m.framework.AssetTypeEnum.Auto, function (s0) {
            if (s0.isfinish) {
                _this.app.getAssetMgr().load("res/pbrRes/SSSSS/" + "normals.png", m4m.framework.AssetTypeEnum.Auto, function (s1) {
                    if (s1.isfinish) {
                        _this.app.getAssetMgr().load("res/pbrRes/" + "brdf.png", m4m.framework.AssetTypeEnum.Auto, function (s2) {
                            if (s2.isfinish) {
                                _this.app.getAssetMgr().load("res/pbrRes/SSSSS/" + "thickness.png", m4m.framework.AssetTypeEnum.Auto, function (s3) {
                                    if (s3.isfinish) {
                                        state.finish = true;
                                    }
                                });
    ...
    test_sssss.prototype.loadIBL = function (lastState, state) {
        var _this = this;
        this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "negx_1.jpg", m4m.framework.AssetTypeEnum.Auto, function (s0) {
            if (s0.isfinish) {
                _this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "negy_1.jpg", m4m.framework.AssetTypeEnum.Auto, function (s1) {
                    if (s1.isfinish) {
                        _this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "negz_1.jpg", m4m.framework.AssetTypeEnum.Auto, function (s2) {
                            if (s2.isfinish) {
                                _this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "posx_1.jpg", m4m.framework.AssetTypeEnum.Auto, function (s3) {
                                    if (s3.isfinish) {
                                        _this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "posy_1.jpg", m4m.framework.AssetTypeEnum.Auto, function (s4) {
                                            if (s4.isfinish) {
                                                _this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "posz_1.jpg", m4m.framework.AssetTypeEnum.Auto, function (s5) {
                                                    if (s5.isfinish) {
                                                        state.finish = true;
                                                    }
                                                });
...
var Joystick = (function () {
    ...
    Joystick.prototype.loadTexture = function (laststate, state) {
        var _this = this;
        this.app.getAssetMgr().load("res/joystick0.png", m4m.framework.AssetTypeEnum.Auto, function (s0) {
            if (s0.isfinish) {
                _this.app.getAssetMgr().load("res/joystick1.png", m4m.framework.AssetTypeEnum.Auto, function (s1) {
                    if (s1.isfinish) {
                        state.finish = true;
                    }
                    else {
...
(function (demo) {
    var TankGame = (function () {
        ...
        TankGame.prototype.loadHeroPrefab = function (laststate, state) {
            var _this = this;
            this.app.getAssetMgr().load("res/prefabs/tank01/tank01.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
        ...
        TankGame.prototype.loadEnemyPrefab = function (laststate, state) {
            var _this = this;
            this.app.getAssetMgr().load("res/prefabs/tank02/tank02.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
        ...
        TankGame.prototype.tankControl = function (delta) {
            if (this.joystick != null) {
                ...
                var goForward = true;
                if (m4m.math.vec2Length(this.joystick.leftAxis) > 0.05) {
                ...
                if (m4m.math.vec2Length(this.joystick.rightAxis) > 0.2) {
...
var test_uiPerfabLoad = (function () {
    ...
    test_uiPerfabLoad.prototype.doLoad = function (name) {
        ...
        var prefabName = name;
        this.assetMgr.load("res/prefabs/UI/" + prefabName + "/" + prefabName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s1) {
            if (s1.isfinish) {
    ...
    test_uiPerfabLoad.prototype.loadShaders = function (lastState, state) {
        this.assetMgr.load("newRes/shader/shader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
            if (s.isfinish) {
                state.finish = true;
            }
        });
...
var test_anim = (function () {
    ...
    test_anim.prototype.start = function (app) {
        ...
        util.loadShader(assetMgr)
            ...
            assetMgr.load("newRes/pfb/model/" + prefabName + "/" + prefabName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
...
var test_assestmgr = (function () {
    ...
    test_assestmgr.prototype.start = function (app) {
        ...
        this.app.getAssetMgr().load("res/shader/Mainshader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (state) {
            if (state.isfinish) {
                _this.app.getAssetMgr().load("res/prefabs/" + assetName + "/" + assetName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                    if (s.isfinish) {
                        _this.baihu = [];
    ...
    var test_light1 = (function () {
        ...
        test_light1.prototype.loadText = function () {
            ...
            return new Promise(function (resolve, reject) {
                _this.tex = new m4m.framework.texture();
                _this.tex.glTexture = new m4m.render.WriteableTexture2D(_this.app.webgl, m4m.render.TextureFormatEnum.RGBA, 512, 512, true);
...
var test_load = (function () {
    ...
    test_load.prototype.start = function (app) {
        ...
        this.scene = this.app.getScene();
        var assetMgr = this.app.getAssetMgr();
        assetMgr.load("newRes/shader/Mainshader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (state) {
            if (state.isfinish) {
                var name_3 = "0001_shengyi_male";
                assetMgr.load("newRes/pfb/model/" + name_3 + "/" + name_3 + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                    if (s.isfinish) {
...
(function (t) {
    var Test_NormalMap = (function () {
        ...
        Test_NormalMap.prototype.loadText = function (laststate, state) {
            ...
            c++;
            this.app.getAssetMgr().load("res/map_diffuse.png", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
                    c--;
                    if (c == 0)
                        state.finish = true;
...
(function (t) {
    var test_posteffect = (function () {
        ...
        test_posteffect.prototype.loadText = function (laststate, state) {
            this.app.getAssetMgr().load("newRes/zg256.png", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
                    state.finish = true;
                }
                else {
        ...
        test_sound.prototype.loadSoundInfe = function () {
            var _this = this;
            {
                ...
                tr.localTranslate = new m4m.math.vector3(0, 0, 0);
                {
                    ...
                    button.onclick = function () {
                        m4m.framework.AudioEx.instance().loadAudioBuffer("res/audio/sound1.mp3", function (buf, err) {
                            _this.once1 = buf;
                ...
                }
                {
                    ...
                    button.onclick = function () {
                        m4m.framework.AudioEx.instance().loadAudioBuffer("res/audio/sound2.mp3", function (buf, err) {
                            _this.once2 = buf;
                ...
                }
                {
                    ...
                    button.onclick = function () {
                        m4m.framework.AudioEx.instance().loadAudioBuffer("res/audio/music1.mp3", function (buf, err) {
    ...
    var test_ui = (function () {
        ...
        test_ui.prototype.start = function (app) {
            ...
            }
            {
                ...
                label.color = new m4m.math.color(1, 0, 0, 1);
                t2d_9.addChild(lab);
                this.app.getAssetMgr().load("res/1.png", m4m.framework.AssetTypeEnum.Auto, function (s) {
                    if (s.isfinish) {
                        _this.app.getAssetMgr().load("res/resources/1.atlas.json", m4m.framework.AssetTypeEnum.Auto, function (state) {
                            if (state.isfinish) {
...
(function (util) {
    function loadShader(assetMgr) {
        return new Promise(function (resolve, reject) {
            assetMgr.load("newRes/shader/Mainshader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (_state) {
                if (_state.isfinish) {
                    resolve();
                }
            });
    ...
    function loadModel(assetMgr, modelName) {
        return new Promise(function (resolve, reject) {
            assetMgr.load("newRes/pfb/model/" + modelName + "/" + modelName + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto, function (s) {
                if (s.isfinish) {
...
var EffectElement = (function (_super) {
    ...
    function EffectElement() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = m4m.framework.EffectElementTypeEnum.SingleMeshType;
        _this.beLoop = false;
        return _this;
    }
...
var test_effecteditor = (function () {
    ...
    test_effecteditor.prototype.addElement = function () {
        var element = new m4m.framework.EffectElementData();
        element.name = "element" + this.length;
        this.effectSysData.elementDic[element.name] = (element);
        this.length++;
        element.type = m4m.framework.EffectElementTypeEnum.SingleMeshType;
        element.initFrameData = new m4m.framework.EffectFrameData();
        element.initFrameData.frameIndex = -1;
        element.initFrameData.attrsData = new m4m.framework.EffectAttrsData();
        element.initFrameData.attrsData.pos = new m4m.math.vector3();
        element.initFrameData.attrsData.scale = new m4m.math.vector3(1, 1, 1);
        element.initFrameData.attrsData.euler = new m4m.math.vector3();
    };
    ...
    (function (framework) {
        var HoverCameraScript = (function (_super) {
            ...
            __decorate([
                ...
                __metadata("design:type", m4m.framework.transform)
...
var guideMask = (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", m4m.math.rect),
        __metadata("design:paramtypes", [m4m.math.rect])
    ], guideMask.prototype, "holeRect", null);
    __decorate([
        m4m.reflect.Field("reference", null, "transform2D"),
        __metadata("design:type", m4m.framework.transform2D)
