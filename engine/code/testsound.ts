        ...
        {
            {
                ...
                tr.localTranslate = new m4m.math.vector3(0, 0, 0);
                {
                    ...
                    button.onclick = () =>
                    {
                        m4m.framework.AudioEx.instance().loadAudioBuffer("res/audio/sound1.mp3", (buf, err) =>
                        {
                            this.once1 = buf;
                            // player.stop();
...

                {
                    ...
                    button.onclick = () =>
                    {
                        m4m.framework.AudioEx.instance().loadAudioBuffer("res/audio/sound2.mp3", (buf, err) =>
                        {
                            this.once2 = buf;
...

                {
                    ...
                    button.onclick = () =>
                    {
                        m4m.framework.AudioEx.instance().loadAudioBuffer("res/audio/music1.mp3", (buf, err) =>
                        {
