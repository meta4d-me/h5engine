...
class Joystick
{
    ...
    {
        this.app.getAssetMgr().load("res/joystick0.png", m4m.framework.AssetTypeEnum.Auto, (s0) =>
        {
            if (s0.isfinish)
            {
                this.app.getAssetMgr().load("res/joystick1.png", m4m.framework.AssetTypeEnum.Auto, (s1) =>
                {
                    if (s1.isfinish)
                    {
                        state.finish = true;
...
namespace demo
{
    export class TankGame implements IState
    {
        ...
        {
            this.app.getAssetMgr().load("res/prefabs/tank01/tank01.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, (s) =>
            {
                if (s.isfinish)
                {
                    var _prefab: m4m.framework.prefab = this.app.getAssetMgr().getAssetByName("tank01.prefab.json") as m4m.framework.prefab;
        ...
        {
            this.app.getAssetMgr().load("res/prefabs/tank02/tank02.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, (s) =>
            {
                if (s.isfinish)
                {
                    var _prefab: m4m.framework.prefab = this.app.getAssetMgr().getAssetByName("tank02.prefab.json") as m4m.framework.prefab;
