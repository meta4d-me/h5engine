...
class test_effecteditor implements IState
{
    ...
    start(app: m4m.framework.application)
    {
        ...
        this.gui.onchange = () =>
        {
            ...
            // {
            //     this.transformRoot = new m4m.framework.transform();
            //     this.effectSystem = this.transformRoot.gameObject.addComponent(m4m.framework.StringUtil.COMPONENT_EFFECTSYSTEM) as m4m.framework.effectSystem;
            //     this.effectSysData = new m4m.framework.EffectSystemData();
            ...
            //         {
            //             let file = fileList[0];
            //             this.effectSysData.elements[0].initFrameData.attrsData.mesh = this.app.getAssetMgr().getAssetByName(file.name) as m4m.framework.mesh;
            ...
            //         {
            //             let matData = new m4m.framework.EffectMatData();
            ...
            //             {
            //                 let file = fileList[0];
            //                 this.effectSysData.elements[0].initFrameData.attrsData.mat.shader = this.app.getAssetMgr().getShader(file.name) as m4m.framework.shader;
            //                 console.log(file.name);
            //             }
            ...
            //             {
            //                 let file = fileList[0];
            //                 this.effectSysData.elements[0].initFrameData.attrsData.mat.diffuseTexture = this.app.getAssetMgr().getAssetByName(file.name) as m4m.framework.texture;
            //                 console.log(file.name);
            //             }
            ...
            //                         this.effectSysData.elements[0].timelineFrame[v] = new m4m.framework.EffectFrameData();
            //                     this.effectSysData.elements[0].timelineFrame[v].frameIndex = v;
            //                     let action = new m4m.framework.EffectActionData();
    ...
    private addElement()
    {
        let element: m4m.framework.EffectElementData = new m4m.framework.EffectElementData();
