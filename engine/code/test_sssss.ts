class test_sssss implements IState
{
    ...
    private init()
    {
        ...
        this.app.getAssetMgr().load("newRes/shader/MainShader.assetbundle.json", m4m.framework.AssetTypeEnum.Auto, (state) =>
        {
            ...
            {
                name = "Head";
                this.app.getAssetMgr().load("newRes/prefabs/" + name + "/" + name + ".assetbundle.json", m4m.framework.AssetTypeEnum.Auto,
                    (s) =>
                    {
                        if (s.isfinish)
                        {
                            ...
                            mr.materials[0].setShader(assetMgr.getAssetByName("pbr_sss.shader.json") as m4m.framework.shader);
    ...
    {
        this.app.getAssetMgr().load("res/pbrRes/SSSSS/" + "albedo.jpg", m4m.framework.AssetTypeEnum.Auto, (s0) =>
        {
            if (s0.isfinish)
            {
                this.app.getAssetMgr().load("res/pbrRes/SSSSS/" + "normals.png", m4m.framework.AssetTypeEnum.Auto, (s1) =>
                {
                    if (s1.isfinish)
                    {
                        this.app.getAssetMgr().load("res/pbrRes/" + "brdf.png", m4m.framework.AssetTypeEnum.Auto, (s2) =>
                        {
                            if (s2.isfinish)
                            {
                                this.app.getAssetMgr().load("res/pbrRes/SSSSS/" + "thickness.png", m4m.framework.AssetTypeEnum.Auto, (s3) =>
                                {
                                    if (s3.isfinish)
                                    {
                                        state.finish = true;
    ...
    {
        this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "negx_1.jpg", m4m.framework.AssetTypeEnum.Auto, (s0) =>
        {
            if (s0.isfinish)
            {
                this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "negy_1.jpg", m4m.framework.AssetTypeEnum.Auto, (s1) =>
                {
                    if (s1.isfinish)
                    {
                        this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "negz_1.jpg", m4m.framework.AssetTypeEnum.Auto, (s2) =>
                        {
                            if (s2.isfinish)
                            {
                                this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "posx_1.jpg", m4m.framework.AssetTypeEnum.Auto, (s3) =>
                                {
                                    if (s3.isfinish)
                                    {
                                        this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "posy_1.jpg", m4m.framework.AssetTypeEnum.Auto, (s4) =>
                                        {
                                            if (s4.isfinish)
                                            {
                                                this.app.getAssetMgr().load("res/pbrRes/IBL/map/" + "posz_1.jpg", m4m.framework.AssetTypeEnum.Auto, (s5) =>
                                                {
                                                    if (s5.isfinish)
                                                    {
                                                        state.finish = true;
