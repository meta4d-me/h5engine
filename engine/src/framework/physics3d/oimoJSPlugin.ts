namespace m4m.framework
{
    ...
    export class OimoJSPlugin implements IPhysicsEnginePlugin {
        ...
        */
            ...
            if (impostor.isBodyInitRequired()) {
                ...
                impostors.forEach( i => {
                    ...
                    if (i === impostor) {
                        ...
                        m4m.math.vec3Subtract(i.object.getWorldPosition() , wPos_impostor ,localPosition);  //子物体世界坐标 与 主物体世界坐标 的差值
        ...
        private _tmpPositionVector: m4m.math.vector3 = new m4m.math.vector3();
